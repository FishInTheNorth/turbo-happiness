                                ...
                                <div class="template-demo">
                                    <div id="demo-tf-box-leading-wrapper">
                                        <div id="tf-box-leading-example" class="mdc-text-field mdc-text-field--box w-100" >
                                            <input type="text" id="tf-box-leading" class="mdc-text-field__input" name="studentID">
                                            <label for="tf-box-leading" class="mdc-text-field__label">工号</label>
                                ...
                                <div class="template-demo">
                                    <div id="demo-tf-box-leading-wrapper1">
                                        <div id="tf-box-leading-example1" class="mdc-text-field mdc-text-field--box w-100" >
                                            <input type="text" id="tf-box-leading1" class="mdc-text-field__input" name="studentName">
                                ...
                                <div class="template-demo">
                                    <div id="demo-tf-box-leading-wrapper4">
                                        <div id="tf-box-leading-example4" class="mdc-text-field mdc-text-field--box w-100" >
                                            <input type="text" id="tf-box-leading4" class="mdc-text-field__input" name="major">
                                            <label for="tf-box-leading4" class="mdc-text-field__label">专业</label>
                                            <div class="mdc-text-field__bottom-line"></div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card table-responsive">
                    <div class="table-heading px-2 px-1 border-bottom">
                        <h1 class="mdc-card__title mdc-card__title--large">教师实训表</h1>
                    </div>
                    <table class="table table-hoverable">
                        ...
                        <tr>
                            ...
                            <td>实习阶段</td>
                            <td>
                                <a class="mdc-button mdc-button--stroked" href="admin_students.jsp">
                                    查看详情
                                </a>
