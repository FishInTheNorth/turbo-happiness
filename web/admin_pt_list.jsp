    ...
    <header class="mdc-toolbar mdc-elevation--z4 mdc-toolbar--fixed">
        <div class="mdc-toolbar__row">
            ...
            <section class="mdc-toolbar__section mdc-toolbar__section--align-end" role="toolbar">
                <font size="3x" face="KaiTi" style="color: white">欢迎你，管理员&nbsp&nbsp&nbsp<span
                        id="mytime"></span></font>
            </section>
        </div>
    </header>
                                ...
                                <div class="template-demo">
                                    <div id="demo-tf-box-leading-wrapper1">
                                        <div id="tf-box-leading-example1" class="mdc-text-field mdc-text-field--box w-100" >
                                            <input type="text" id="tf-box-leading1" class="mdc-text-field__input" name="schoolYear" placeholder="如：2019-2019学年">
                                            <label for="tf-box-leading1" class="mdc-text-field__label">学年</label>
                                            <div class="mdc-text-field__bottom-line"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="template-demo">
                                    <div id="demo-tf-box-leading-wrapper2">
                                        <div id="tf-box-leading-example2" class="mdc-text-field mdc-text-field--box w-100" >
                                            <input type="date" id="tf-box-leading2" class="mdc-text-field__input" name="beginTime">
                                            <label for="tf-box-leading2" class="mdc-text-field__label">开始时间</label>
                                            <div class="mdc-text-field__bottom-line"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="template-demo">
                                    <div id="demo-tf-box-leading-wrapper3">
                                        <div id="tf-box-leading-example3" class="mdc-text-field mdc-text-field--box w-100" >
                                            <input type="date" id="tf-box-leading3" class="mdc-text-field__input" name="endTime">
                                            <label for="tf-box-leading3" class="mdc-text-field__label">结束时间</label>
                                            <div class="mdc-text-field__bottom-line"></div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="mdc-card table-responsive">
                    ...
                    <table class="table table-hoverable">
                        ...
                        <tr>
                            ...
                            <td>2019-2-2</td>
                            <td>
                                <a class="mdc-button mdc-button--stroked" href="admin_pt_teacher.jsp">
                                    详细信息
                                </a>
                            </td>
                        </tr>
